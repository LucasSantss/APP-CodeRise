...
export function normalizeWebhook(payload) {
  ...
  const topicMap = {
    // Formato plural (webhooks registrados via API)
    ...
    // Formato singular (webhooks reais da Nuvemshop)
  ...
  // SEMPRE busca via API: o payload do webhook tem estoque/categoria desatualizados.
