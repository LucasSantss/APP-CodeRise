 ...
 * Converte do formato interno CodeRise para o formato exato da Suri,
 * incluindo stocks com o ID real do depósito.
 */
...
/**
 * Converte um produto no formato interno CodeRise para o formato da Suri.
 * Usa o ID real do depósito para montar o campo stocks.
 */
 ...
 * Busca automaticamente o ID do depósito para montar stocks.
 */
export async function syncProduct(endpoint, token, product) {
  // Busca o ID real do depósito da Suri
...
/**
 * Desativa um produto na Suri (quando deletado no ecommerce).
 */
