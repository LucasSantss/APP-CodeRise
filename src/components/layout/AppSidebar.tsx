...
import { LayoutDashboard, Users, Link2, Settings, Webhook, MessageSquare, ShoppingCart, ScrollText, Zap, Activity, GitMerge, Truck } from 'lucide-react';
import {
...
const AppSidebar = () => {
  ...
  const userItems = [
    ...
    { title: 'Logística',  url: '/dashboard/logistics',        icon: Truck,           show: anyChatbotEnabled },
